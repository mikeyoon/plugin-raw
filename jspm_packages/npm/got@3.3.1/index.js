...
(function(Buffer, process) {
  ...
  function got(url, opts, cb) {
    ...
    opts = objectAssign({protocol: 'http:'}, typeof url === 'string' ? urlLib.parse(prependHttp(url)) : url, opts);
    ...
    function get(opts, cb) {
      ...
      if (opts.agent === undefined) {
        ...
        if (process.version.indexOf('v0.10') === 0 && fn === https && (typeof opts.ca !== 'undefined' || typeof opts.cert !== 'undefined' || typeof opts.ciphers !== 'undefined' || typeof opts.key !== 'undefined' || typeof opts.passphrase !== 'undefined' || typeof opts.pfx !== 'undefined' || typeof opts.rejectUnauthorized !== 'undefined')) {
  ...
  ['get', 'post', 'put', 'patch', 'head', 'delete'].forEach(function(el) {
